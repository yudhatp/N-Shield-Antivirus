...
begin
 ...
 DebugPrivilege(true); //modified by yudha
...
//kode utama
initialization
 //jika terdeteksi oleh antivirus maka hentikan,opsional bisa tidak dipakai [?]
 if IsHeuristicScan then Halt;
